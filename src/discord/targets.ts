...
export async function resolveDiscordTarget(
  ...
  // Type cast options to DiscordTargetParseOptions since DirectoryConfigParams is incompatible
  // safeParseDiscordTarget expects DiscordTargetParseOptions which is just { defaultKind?: MessagingTargetKind; ambiguousMessage?: string }
  // DirectoryConfigParams has cfg, accountId, query, limit.
  // We explicitly create parseOptions to avoid type mismatch
